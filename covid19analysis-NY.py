...
print('Based on current weekly trends, it would take ' + str(
    five_hundred) + ' days until the average number of new daily cases in '
                     'New York State is at 500 or less.')

fifty = ceil((50 - b) / m)
print('Based on current weekly trends, it would take ' + str(
    fifty) + ' days until the average number of new daily cases in the'
                    'New York State is at 50 or less.')
